...
export function completeness(
  ...
  const checks: Check[] = [
    ...
    },
    {
      ...
      weight: 18,
      done: Boolean(property.accessCode) || (base?.arrivalSteps.length ?? 0) > 0,
    ...
    },
    {
      ...
      label: "Cómo moverse",
      weight: 8,
      done: (base?.transport.length ?? 0) > 0,
    ...
    },
    {
      ...
      weight: 8,
      done: property.contacts.length > 0,
    ...
    },
    {
      ...
      label: "Salida",
      weight: 6,
      done: (base?.checkoutSteps.length ?? 0) > 0,
